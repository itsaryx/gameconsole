    ...
    createBricks() {
        ...
        for (let c = 0; c < this.brickColumnCount; c++) {
            ...
            for (let r = 0; r < this.brickRowCount; r++) {
                // Different brick types with different resistances
                const brickType = Math.random() < 0.3 ? 2 : 1; // 30% chance of a two-hit brick
                this.bricks[c][r] = { 
                    x: 0, 
                    y: 0, 
                    status: brickType,
        ...
        for (let c = 0; c < this.brickColumnCount; c++) {
            for (let r = 0; r < this.brickRowCount; r++) {
                if (this.bricks[c][r].status > 0) {
                    ...
                    // Different colors based on brick status
                    const colorMap = {
                        2: `hsl(${c * 20}, 100%, 50%)`,     // Two-hit bricks
                        1: `hsl(${c * 20}, 70%, 50%)`       // One-hit bricks
                    };
